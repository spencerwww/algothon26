"""Standalone Algothon strategy: broad residual mean reversion + four pairs.
...
2. The remaining instruments trade a continuous residual-level
...
class UpdatedStrategy:
    """Combine non-overlapping sleeves into one legal position vector."""
